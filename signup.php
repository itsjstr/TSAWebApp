  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="form-group">
        ...
        <input name="last" type="text" class="form-control" id="exampleInputGrad" aria-describedby="emailHelp">
      </div>
      <div class="form-group">
        <label for="exampleInputId">Student Id</label>
        <input name="last" type="text" class="form-control" id="exampleInputId" aria-describedby="emailHelp">
      </div>
      <div class="form-group">
